var gitblog = function(config) {
    ...
    var Footer = function() {
        ...
        this.icons = [];
        this.icon_num = 0;
        this.content = '<bodylink="pink"alink="#BEBEBE"vlink="#BEBEBE"><span style="font-size:10px"><font color-"#BEBEBE">Copyright © <script>document.write( new Date().getFullYear() );</script> Powered by <a href="http://#">cjzwjyun</a> . All rights reserved.<br><a href="http://beian.miit.gov.cn">苏ICP备20014892号-2</a></span></font></span>';
    }
